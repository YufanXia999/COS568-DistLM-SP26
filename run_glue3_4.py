...
def train(args, train_dataset, model, tokenizer):
    ...
    # ### NEW/MODIFIED FOR TASK 4: Profiler Context Manager ###
    with torch.profiler.profile(
        ...
        for _ in train_iterator:
            ...
            for step, batch in enumerate(epoch_iterator):
                ...
                # DDP automatically performs gradient synchronization during backward pass
                loss.backward()
                ...
                # Exit early after profiling 4 steps (1 wait + 3 active)
                if step >= 4:
                    break
            if step >= 4: break
...
def main():
    ...
    # ### NEW/MODIFIED FOR PART 3: Wrap the model with DDP ###
    if args.local_rank != -1:
        # Since you are on CPUs, we do not pass device_ids. 
        # DDP will automatically sync gradients across the nodes during loss.backward()
